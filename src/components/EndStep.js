...
function EndStep(props){
    return <div style={{display: 'flex', flexDirection: 'column'}}>
        ...
        <div style={{display: 'flex', flexDirection: 'row', justifyContent:'center'}}><QuestionScreen question={"Data Made Available"}/></div>

    </div>
    return <QuestionScreen question={"Data Made Available"}/>
}
